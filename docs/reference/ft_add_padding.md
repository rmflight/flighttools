...
Provides the code for adding padding to a plot, which is sometimes
necessary when generating UpSet plots via ComplexHeatmap::UpSet, as the
labels will be too long and get cutoff.
