...
It happens very often, that we don't want to keep old figures laying
around from a previous rendering of the document. So this creates the
code we would insert into a setup chunk to go and delete the previously
created figures.
